        ...
        $(document).ready(function () {
            ...
            var table = $('#register').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: "extn", name: "extn",
                        render: function (data, type, row, meta) { return (type === 'display' ? '<label>'+ $($('#register').DataTable().column(meta.col).header()).html() +':</label>' : null ) +  (function(data) { return 'Call me at '+ data +'!' })(data, type, row, meta); }
                    }
                ]
            })
