            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    @foreach($filters as $filter)
                        <tr>
                            <td>{{ optional($filter->Property)->id }}</td>
                            <td>{{ optional($filter->InputType)->id }}</td>
                            <td>{{ $filter->order }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('filters.filter.show', $filter->id ) }}" class="btn btn-info" title="Show Filter">
