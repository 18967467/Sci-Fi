...
<body id="page-top">
  ...
  <section id="about" class="about-section text-center">
    <div class="container">
      ...
      <img src="{{ asset('img/bg-spider.png') }}" class="img-fluid" alt="">
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row align-items-center no-gutters mb-4 mb-lg-5">
        <div class="col-xl-8 col-lg-7">
          <img class="img-fluid mb-3 mb-lg-0" src="{{ asset('img/bg-crowdsourcing.jpg') }}" alt="">
        </div>
      ...
      <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
        <div class="col-lg-6">
          <img class="img-fluid" src="{{ asset('img/bg-social-media.jpg') }}" alt="">
        </div>
        <div class="col-lg-6">
